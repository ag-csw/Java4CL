...
public class BasicKnowledgeAssetTest {
	...
	public void assetShouldConceptualizeItsCanonicalExpression() {
		KnowledgeExpression expression = new AbstractBasicKnowledgeExpression(CL.LANG){};
		BasicKnowledgeAssetCanonical asset = new BasicKnowledgeAssetCanonical(CL.CL_DEFAULT_ENVIRONMENT, expression);
