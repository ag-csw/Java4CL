...
case class Equation(comments: CommentSet, terms: TermSet) extends SimpleSentence {
...
case class Biconditional(comments: CommentSet, sentences: SentenceSet) extends BooleanSentence {
...
case class Implication(comments: CommentSet, antecedent: Sentence, consequent: Sentence) extends BooleanSentence
case class Conjunction(comments: CommentSet, conjuncts: SentenceSet) extends BooleanSentence
case class Disjunction(comments: CommentSet, disjuncts: SentenceSet) extends BooleanSentence
case class Negation(comments: CommentSet, body: Sentence) extends BooleanSentence
...
case class InDiscourseStatement(comments: CommentSet, terms: TOSMSet) extends DiscourseStatement
case class OutDiscourseStatement(comments: CommentSet, terms: TOSMSet) extends DiscourseStatement
case class Titling(comments: CommentSet, title: Name, body: Text) extends Statement
case class Schema(
  comments: CommentSet,
